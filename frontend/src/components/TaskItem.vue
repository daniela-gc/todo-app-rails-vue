  ...
  <div class="grid grid-rows-2 gird-cols-1">
    ...
    <div class="flex items-center">
      ...
      <input
        type="text"
        :value="description"
        @input="$emit('update:description', $event.target.value, id)"
        :class="[
          { 'line-through': checked },
          checked ? 'text-gray-400' : 'text-gray-600'
        ]"
        class="w-full pl-2 bg-transparent border-none rounded-md focus:ring-0"
      />
